...
set_property -dict \{ PACKAGE_PIN V10   IOSTANDARD LVCMOS33 \} [get_ports \{ D14 \}]; #IO_L21P_T3_DQS_14 Sch=sw[15]\
\
## LEDs\
set_property -dict \{ PACKAGE_PIN H17   IOSTANDARD LVCMOS33 \} [get_ports \{ E16 \}]; #IO_L18P_T2_A24_15 Sch=led[0]\
